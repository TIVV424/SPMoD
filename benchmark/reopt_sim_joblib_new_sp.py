...
print("Number of drivers between 6-10,", len(driver_pick))
...
for SP_t in SP_list:
    ...
    print("Number of orders between 6-10,", len(order_pick))
    ...
    temp_out = Parallel(n_jobs=int(cpu_count() - 2), prefer="processes")(
